...
public interface Configuration {
     ...
     * follow one predicate. The predicate is applied to unmodifiable set, and
     * the VMs are unmutable so this call can not modify this
     *
     * @param pred
     *            a predicate over the hosted VMs of a Node with no side-effect
     *            on the set.
     ...
     * @return the number of nodes with given state if not null, or the number
     *         of nodes if null
     */
     ...
     * @return the number of vms which are specified running on the node ; null
     ...
     * @param n
     *            a Node
     * @return the state of the Node in the configuration, or null if the Node
     *         is not known
     */
     ...
     * @param n
     *            a VM
     * @return the state of the VM in the configuration, or null if the VM is
     *         not known
     */
