...
public class ActionGraph {
	...
	/**
	 * add a dependency between two actions. if one of the actions did not exist,
	 * it is added.
	 *
	 * @param a
	...
	/**
	 * @return a new linkedhashet of all the actions added, in the order they were
	 *         added
	 */
	...
	public String toString() {
		return dependencies.keySet().toString();
	}
}
