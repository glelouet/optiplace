...
public class ResourcesSpecificationTest {
	...
	List<Node> expected = Arrays.asList(nodes[0], nodes[2], nodes[4], nodes[6], nodes[8], nodes[1], nodes[3],
		nodes[5], nodes[7], nodes[9]);
	...
	List<VM> expected = Arrays.asList(vms[0], vms[2], vms[4], vms[6], vms[8], vms[1], vms[3],
		vms[5], vms[7], vms[9]);
