...
/** A customizable decision module. We user has to specify the state of each VM
 * belonging to the configuration. By default, all the state stay untouched.
...
public class CustomizableDecisionModule extends DecisionModule {
  ...
  @Override
  public Configuration compute(Configuration currentConf)
