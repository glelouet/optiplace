...
/** Abstract class to provide a Driver that execute an action using the xenapi on
 * a remote host.
 * <table>
 * <tr>
...
public abstract class XenAPIDriver extends Driver {
  ...
  public XenAPIDriver(Action a, PropertiesHelper properties)
      throws PropertiesHelperException {
    super(a);

    port = properties.getRequiredPropertyAsInt(PORT_PROPERTY);
    username = properties.getRequiredProperty(USERNAME_PROPERTY);
    password = properties.getRequiredProperty(PASSWORD_PROPERTY);
  }

  @Override
  public String toString() {
    return "xenapi(" + getAction().toString() + ")";
  }
