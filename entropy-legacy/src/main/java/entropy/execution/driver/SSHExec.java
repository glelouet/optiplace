...
/** Tool to execute remote shell command on a SSH server. The tool support
 * authentification through password or identity file.
...
public class SSHExec {
   ...
   * @throws JSchException if an error occurs */
  public void useIdentity(String filename, String passPhrase)
