...
public abstract class FileTimedReconfigurationPlanSerializer implements
    TimedReconfigurationPlanSerializer {
  ...
  public final entropy.plan.ReconfigurationResult read(String path) throws IOException,
  ...
  /** Write a configuration to a file. If the parent folder does not exists, it
   * is created.
   * @param plan the plan to write
   * @param path of the file
   * @throws java.io.IOException if an error occurred while writing the file */
  public final void write(entropy.plan.ReconfigurationResult plan, String path)
      throws IOException {
