...
/** A catalog that contains several constraints builder, associated by their
 * name.
 * @author Fabien Hermenier */
public interface XMLConstraintsCatalog {
   ...
   * @return the constraints builder or {@code null} if the identifier is
   * unknown */
  XMLPlacementConstraintBuilder getConstraint(String id);
}
