...
public class LazySplitBuilder implements PBPlacementConstraintBuilder {
   ...
   * constraint */
  @Override
  public LazySplit buildConstraint(VJobElementBuilder eBuilder,
      List<PBVJob.vjob.Param> args) throws ConstraintBuilderException {
    PBPlacementConstraintBuilders.ensureArity(this, args, 2);
    ManagedElementSet<VirtualMachine> vms1 = PBPlacementConstraintBuilders
        .makeVMs(eBuilder, args.get(0));
    PBPlacementConstraintBuilders.noEmptySets(args.get(0), vms1);
    ManagedElementSet<VirtualMachine> vms2 = PBPlacementConstraintBuilders
        .makeVMs(eBuilder, args.get(1));
