...
/** A table of symbols to store variables in a vjob description. A prolog may be
 * used to insert predefined variables.
...
public class SymbolsTable {
  ...
  /** Make a new table of symbols that use a prolog. All the variables of the
   * prolog will be inserted into the table
   * @param prolog the prolog */
  public SymbolsTable(PlasmaVJob prolog) {
  ...
  /** Declare a new variable. The variable is inserted into the current vjob.
   ...
   * @param label the label of the variable
   * @return {@code true} if the variable is already declared, {@code false}
   * otherwise */
  ...
  public String toString() {
    ...
    for (Iterator<Map.Entry<String, Content>> ite = type.entrySet().iterator(); ite
        .hasNext();) {
