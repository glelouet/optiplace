...
/** A tree to build a constraint. Root of the tree is the constraint identifier
 * while childs are the parameters.
...
public class ConstraintTree extends VJobTree {
  ...
  public ConstraintTree(Token t, SemanticErrors errs, ConstraintsCatalog c,
      PlasmaVJob v) {
    super(t, errs);
    catalog = c;
    vjob = v;
  ...
  /** Build the constraint. The constraint is builded if it exists in the catalog
   * and if the parameters are compatible with the constraint signature.
