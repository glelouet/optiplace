...
public class ExplodedMultiSet<T extends ManagedElement> implements
VJobMultiSet<T> {
  ...
  public Set<ManagedElementSet<T>> expand() {
    Set<ManagedElementSet<T>> l = new HashSet<ManagedElementSet<T>>();
  ...
  public ManagedElementSet<T> getElements() {
    ManagedElementSet<T> r = new SimpleManagedElementSet<T>();
