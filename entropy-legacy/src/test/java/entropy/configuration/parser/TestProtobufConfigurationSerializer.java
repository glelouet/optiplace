...
public class TestProtobufConfigurationSerializer {
  ...
  public void test() {
    ...
    FileConfigurationSerializer s = ProtobufConfigurationSerializer
        .getInstance();
    File tmpF = null;
    try {
      ...
      // Detailed comparison as VM and node comparison is just about the
      // name
      for (VirtualMachine vm : cfg.getAllVirtualMachines()) {
        ...
        Assert.assertEquals(vm.getMemoryConsumption(),
            vm2.getMemoryConsumption());
