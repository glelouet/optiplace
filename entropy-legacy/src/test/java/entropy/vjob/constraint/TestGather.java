...
public class TestGather {
  ...
  public void testIsSatisfied() {
    ...
    vms.add(vm1);
    vms.add(vm2);
    Assert.assertTrue(new Gather(new SimpleManagedElementSet<VirtualMachine>())
        .isSatisfied(cfg));
    Assert
        .assertFalse(new Gather(cfg.getAllVirtualMachines()).isSatisfied(cfg));
  ...
  public void testGetMisplaced() {
    ...
    vms.add(vm1);
    vms.add(vm2);
    Assert.assertEquals(new Gather(
        new SimpleManagedElementSet<VirtualMachine>()).getMisPlaced(cfg),
    ...
    Assert.assertEquals(new Gather(vms).getMisPlaced(cfg),
        new SimpleManagedElementSet<VirtualMachine>());
  }
