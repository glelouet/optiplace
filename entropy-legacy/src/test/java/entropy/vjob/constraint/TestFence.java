...
public class TestFence {
  ...
  public void testIsSatisfied() {
    ...
    vms.add(vm2);
    vms.add(vm3);
    Assert.assertFalse(new Fence(cfg.getAllVirtualMachines(),
        new SimpleManagedElementSet<Node>()).isSatisfied(cfg));
    Assert.assertTrue(new Fence(vms, grp1).isSatisfied(cfg));
    grp1.remove(n1);
    Assert.assertFalse(new Fence(cfg.getAllVirtualMachines(), grp1)
        .isSatisfied(cfg));
  }
  ...
  public void testGetMisPlaced() {
    ...
    vms.add(vm2);
    vms.add(vm3);
    ManagedElementSet<VirtualMachine> bads = new Fence(
        cfg.getAllVirtualMachines(), new SimpleManagedElementSet<Node>())
        .getMisPlaced(cfg);
