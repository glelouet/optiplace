...
/** A mock driver. The execution times vary between 0 to 1 seconds. The driver
 * may fail
...
public final class MockDriver extends Driver {
  ...
  public void execute() throws DriverException {
    long sleep = (long) (/* a.getFinishMoment() - a.getStartMoment() + */Math
        .random() * MAX_JITTER);
    try {
      System.out.println("Starting " + a.toString() + " for " + sleep
          + " msecs.");
      Thread.sleep(sleep);
