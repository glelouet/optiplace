...
public class TestVMTendencyPredictor {
  ...
  // test fails : java.lang.AssertionError: expected:<3> but was:<5>
  ...
  // for (int i = 2; i <= 5; i++) {
  // vm1 = new SimpleVirtualMachine("VM1", 1, i, 1);
  // p1.predictCPUDemand(vm1);
  // // System.err.println(vm1 + " " + p1);
  // System.err.println(vm1.getCPUConsumption() + " "
  // + vm1.getCPUDemand());
  ...
  public void testWithProbalityCurve() {
    ...
    for (double i = 0.0; i < Math.PI * 2; i += 0.1, t++) {
      ...
      vm1 = new SimpleVirtualMachine("VM1", 1, x, 1);
      p1.predictCPUDemand(vm1);
