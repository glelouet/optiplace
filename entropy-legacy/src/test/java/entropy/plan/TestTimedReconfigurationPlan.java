...
/** Unit tests for Defaultentropy.plan.ReconfigurationResult.
 * @author Fabien Hermenier */
@Test(groups = { "unit" })
public class Testentropy.plan.ReconfigurationResult {

  private static final String RESOURCES_LOCATION = "src/test/resources/entropy/plan/Testentropy.plan.ReconfigurationResult.";

  /** Create a basic reconfiguration plan for tests purpose.
   * @return the plan */
  private Defaultentropy.plan.ReconfigurationResult createPlan() {
    return new Defaultentropy.plan.ReconfigurationResult(
        TestHelper.readConfiguration(RESOURCES_LOCATION + "conf.txt"));
  }
  ...
  public void testAddAndSize() {
    entropy.plan.ReconfigurationResult plan = createPlan();
