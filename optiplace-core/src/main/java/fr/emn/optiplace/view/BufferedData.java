...
/**
 *
 * {@link ProvidedData} extending {@link List}. The list is the buffer so
 * {@link #lines()} returns the stream of lines.
 *
...
public class BufferedData extends ArrayList<String>implements ProvidedData {
	...
	private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(BufferedData.class);
