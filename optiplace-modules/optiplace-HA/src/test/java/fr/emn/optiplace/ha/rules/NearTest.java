...
public class NearTest extends SolvingExample {
	...
	public void test() {
		...
		Assert.assertTrue(d.getSite(d.getNodeHost(vm0)) == d.getSite(d.getNodeHost(vm1)), "vms are on different site : "
		    + vm0 + "->" + d.getSite(d.getNodeHost(vm0)) + ", " + vm1 + "->" + d.getSite(d.getNodeHost(vm1)));
	}
}
