...
public class TestRun {
	...
	public void testToString() {
		Run s = new Run(new SimpleVirtualMachine("VM1", 1, 2, 3),
	...
	public Object[][] getWrongRuns() {
		return new Object[][]{
				{new Run(new SimpleVirtualMachine("VM5", 1, 1, 1),
						new SimpleNode("n1", 1, 2, 3))}, // a unknown VM
				{new Run(new SimpleVirtualMachine("VM10", 1, 1, 1),
						new SimpleNode("n1", 1, 2, 3))}, // bad state
				{new Run(new SimpleVirtualMachine("VM1", 1, 1, 1),
