...
import entropy.view.scheduling.MockAction;
import entropy.view.scheduling.action.Action;
import entropy.view.scheduling.action.ActionComparator;
...
public class TestActionComparator {
	...
	/**
	 * Make 2 TimedAction. t[0].getFinishMoment() < t[1].getFinishMoment() &&
	 * t[0].getStartMoment() > t[1].getEndMoment()
	 * 
	...
	public void testFinishMomentComparison() {
		...
		ActionComparator cmp = new ActionComparator(
				ActionComparator.Type.finish);
