...
import entropy.view.scheduling.MockPlanVisualizer;
...
public class TestMigration {
	...
	public void testGets() {
		Migration m = new Migration(new SimpleVirtualMachine("VM1", 1, 1, 1),
				new SimpleNode("N1", 1, 1, 1), new SimpleNode("N2", 1, 1, 1));
	...
	public void testEquals() {
		Migration m = new Migration(new SimpleVirtualMachine("VM1", 1, 1, 1),
				new SimpleNode("N1", 1, 1, 1), new SimpleNode("N2", 1, 1, 1));
		Migration m2 = new Migration(new SimpleVirtualMachine("VM1", 1, 1, 1),
				new SimpleNode("N1", 1, 1, 1), new SimpleNode("N2", 1, 1, 1));
		Assert.assertEquals(m, m2);

		// Must fails
		Migration m3 = new Migration(new SimpleVirtualMachine("VM", 1, 1, 1),
				new SimpleNode("N1", 1, 1, 1), new SimpleNode("N2", 1, 1, 1));
		Assert.assertNotSame(m, m3);
		Migration m4 = new Migration(new SimpleVirtualMachine("VM1", 1, 1, 1),
				new SimpleNode("N2", 1, 1, 1), new SimpleNode("N2", 1, 1, 1));
		Assert.assertNotSame(m, m4);
		Migration m5 = new Migration(new SimpleVirtualMachine("VM1", 1, 1, 1),
				new SimpleNode("N1", 1, 1, 1), new SimpleNode("N3", 1, 1, 1));
	...
	public void testToString() {
		Migration m1 = new Migration(new SimpleVirtualMachine("vm1", 1, 2, 3),
				new SimpleNode("n1", 1, 2, 3), new SimpleNode("n2", 1, 2, 3));
	...
	public Object[][] wrongMigrationAppendsData() {
		return new Object[][]{
				{new Migration(new SimpleVirtualMachine("VM5", 1, 1, 1),
						new SimpleNode("n1", 1, 2, 3), new SimpleNode("n2", 1,
								2, 3))}, // migration
				// of
				// a
				// unknown
				// VM
				{new Migration(new SimpleVirtualMachine("VM10", 1, 1, 1),
						new SimpleNode("n1", 1, 2, 3), new SimpleNode("n2", 1,
								2, 3))}, // bad
				// state
				{new Migration(new SimpleVirtualMachine("VM1", 1, 1, 1),
						new SimpleNode("n2", 1, 2, 3), new SimpleNode("n1", 1,
								2, 3))}, // migration
				// on
				// a
				// VM
				// mislocated.
				{new Migration(new SimpleVirtualMachine("VM1", 1, 1, 1),
						new SimpleNode("n1", 1, 2, 3), new SimpleNode("n7", 1,
								2, 3))}, // migration
				// on
				// a
				// unknow
				// node
				{new Migration(new SimpleVirtualMachine("VM1", 1, 1, 1),
						new SimpleNode("N55", 1, 1, 1), new SimpleNode("n2", 1,
								2, 3))} // migration
		// from
		// a
		// unknown
