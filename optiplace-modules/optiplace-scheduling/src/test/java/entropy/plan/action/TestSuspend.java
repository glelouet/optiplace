...
public class TestSuspend {
	...
	public void testToString() {
		Suspend s = new Suspend(new SimpleVirtualMachine("VM1", 1, 2, 3),
	...
	public Object[][] wgetWrongSuspends() {
		return new Object[][]{
				{new Suspend(new SimpleVirtualMachine("VM5", 1, 1, 1),
						new SimpleNode("n1", 1, 2, 3), new SimpleNode("n2", 1,
								2, 3))}, // unknown VM
				{new Suspend(new SimpleVirtualMachine("VM10", 1, 1, 1),
						new SimpleNode("n1", 1, 2, 3), new SimpleNode("n2", 1,
								2, 3))}, // bad
				// state
				{new Suspend(new SimpleVirtualMachine("VM1", 1, 1, 1),
