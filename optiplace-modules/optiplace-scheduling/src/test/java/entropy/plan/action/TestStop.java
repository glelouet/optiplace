...
public class TestStop {
	...
	public void testToString() {
		Stop s = new Stop(new SimpleVirtualMachine("VM1", 1, 2, 3),
	...
	public Object[][] getWrongRuns() {
		return new Object[][]{
				{new Stop(new SimpleVirtualMachine("VM5", 1, 1, 1),
						new SimpleNode("n1", 1, 2, 3))}, // a unknown VM
				{new Stop(new SimpleVirtualMachine("VM1", 1, 1, 1),
						new SimpleNode("n1", 1, 2, 3))}, // bad state
				{new Stop(new SimpleVirtualMachine("VM10", 1, 1, 1),
						new SimpleNode("n2", 1, 2, 3))}, // migration on a
		// unknown node
		};
	}
