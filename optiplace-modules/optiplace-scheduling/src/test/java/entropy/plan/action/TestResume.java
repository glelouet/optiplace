...
public class TestResume {
	...
	public void testToString() {
		Resume s = new Resume(new SimpleVirtualMachine("VM1", 1, 2, 3),
	...
	public Object[][] getWrongResume() {
		return new Object[][]{
				{new Resume(new SimpleVirtualMachine("VM5", 1, 1, 1),
						new SimpleNode("n1", 1, 2, 3), new SimpleNode("n2", 1,
								2, 3))}, // a unknown VM
				{new Resume(new SimpleVirtualMachine("VM10", 1, 1, 1),
						new SimpleNode("n1", 1, 2, 3), new SimpleNode("n2", 1,
								2, 3))}, // bad state
				{new Resume(new SimpleVirtualMachine("VM1", 1, 1, 1),
