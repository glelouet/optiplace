...
public class TestInstantiate {
	...
	public void testToString() {
		Instantiate s = new Instantiate(
				new SimpleVirtualMachine("VM1", 1, 2, 3));
	...
	public Object[][] getWrongInstantiates() {
		return new Object[][]{
				{new Instantiate(new SimpleVirtualMachine("VM10", 1, 1, 1))}, // bad
				// state
				{new Instantiate(new SimpleVirtualMachine("VM1", 1, 1, 1))}, // migration
		// on
		// a
		// unknown
		// node
