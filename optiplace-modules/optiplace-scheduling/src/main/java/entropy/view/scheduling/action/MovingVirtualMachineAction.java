...
/**
 * An abstract action to describe a virtual machine that move from one online
 * node to one another. The state of the virtual machine may change during the
 * action.
 * 
...
public abstract class MovingVirtualMachineAction extends VirtualMachineAction {
	 ...
	 *            the destination node
	 * @param s
	 *            the moment the execution of the action starts.
	 * @param f
	 *            the moment the execution finish.
	 */
	public MovingVirtualMachineAction(VirtualMachine v, Node src, Node dst,
			int s, int f) {
		super(v, src, s, f);
