...
public interface DurationEvaluator {
	...
	/**
	 * Evaluate the duration of a migration action for a specific virtual
	 * machine.
	 * 
	 * @param vm
	 *            the involved virtual machine
	...
	/**
	 * Evaluate the duration of a local suspend action for a specific virtual
	 * machine.
	 * 
	 * @param vm
	 *            the involved virtual machine
	 ...
	 *             if an error occurred during evaluation
	 */
	int evaluateLocalSuspend(VirtualMachine vm)
			throws DurationEvaluationException;

	/**
	 * Evaluate the duration of a local resume action for a specific virtual
	 * machine.
	 * 
	 * @param vm
	 *            the involved virtual machine
	 ...
	 *             if an error occurred during evaluation
	 */
	int evaluateLocalResume(VirtualMachine vm)
			throws DurationEvaluationException;

	/**
	 * Evaluate the duration of a remote resume action for a specific virtual
	 * machine.
	 * 
	 * @param vm
	 *            the involved virtual machine
	 ...
	 *             if an error occurred during evaluation
	 */
	int evaluateRemoteResume(VirtualMachine vm)
			throws DurationEvaluationException;

	/**
	 * Evaluate the duration of creating a new VM that can be launched after.
	 * TODO: Not a great place for this. Should be indicated by the "real" forge
	 * instead.
	 * 
	 * @param vm
	 *            the VM to forge
	 * @return the estimated duration of -1 in case of errors
	 * @throws DurationEvaluationException
	 *             if an error occurred during evaluation
	 */
	int evaluateForge(VirtualMachine vm) throws DurationEvaluationException;
	 ...
	 * @return the estimated duration or -1 in case of errors
	 * @throws DurationEvaluationException
	 *             if the evaluation of the duration fails
	 */
