...
public final class ActionModels {
	 ...
	 */
	public static List<DemandingSlice> extractDemandingSlices(
			List<? extends ActionModel> actions) {
	 ...
	 */
	public static List<ConsumingSlice> extractConsumingSlices(
			List<? extends ActionModel> actions) {
	 ...
	 * @return an array of durations, in the same order that the actions
	 */
	public static IntVar[] extractDurations(
			List<? extends ActionModel> actions) {
		return extractDurations(actions
	 ...
	 * @return an array of costs, in the same order that the actions
	 */
	public static IntVar[] extractCosts(
			List<? extends ActionModel> actions) {
