 ...
 */
public interface TimedReconfigurationPlan extends Iterable<Action> {
	...
	/**
	 * Add a new action to the plan. At most one action per element of the
	...
	/**
	 * A String representation of a plan. Indicated a timeline with the start
	 * moment and the end moment of each action
	 * 
	 ...
	 */
	TimedExecutionGraph extractExecutionGraph();
