...
/**
 * A comparator for Action. Can be used to compare Action regarding to their
 * start moment or their finish moment.
 * 
...
public class ActionComparator implements Comparator<Action>, Serializable {
	 ...
	 * 
	 * @param t
	 *            The comparison mode. on the finish moment
	 */
	 ...
	 * @param o2
	 *            the second action
	 * @return a negative number, if o1 is inferior to o2. A positive number of
	 *         o1 is greater than o2. If both action are equals, returns 0.
	 */
	@Override
