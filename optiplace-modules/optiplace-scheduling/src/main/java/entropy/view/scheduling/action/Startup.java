...
/**
 * An action to start an offline node. Once the execution is finished, the node
 * is online.
 * 
...
public class Startup extends NodeAction {
	 ...
	 * @param f
	 *            the moment the action is finished
	 */
	 ...
	 * @return true if o is an instance of Startup and if both actions act on
	 *         the same node
	 */
	@Override
	 ...
	 * configuration. The node must be offline in the source configuration and
	 * online is the destination configuration.
	 * 
	 * @param src
