...
public final class Slices {
	 ...
	 */
	public static int[] extractCPUHeights(List<? extends Slice> slices) {
	 ...
	 */
	public static int[] extractMemoryHeights(List<? extends Slice> slices) {
	 ...
	 */
	public static IntVar[] extractEnds(Slice[] slices) {
		IntVar[] ends = new IntVar[slices.length];
		for (int i = 0; i < slices.length; i++) {
			ends[i] = slices[i].end();
		}
		return ends;
	 ...
	 * @return an array of variable with regards to the order of the slices.
	 */
	public static IntVar[] extractEnds(List<? extends Slice> slices) {
	 ...
	 * @return an array of variable with regards to the order of the slices.
	 */
	public static IntVar[] extractStarts(Slice[] slices) {
		IntVar[] ends = new IntVar[slices.length];
		for (int i = 0; i < slices.length; i++) {
	 ...
	 * @return an array of variable with regards to the order of the slices.
	 */
	public static IntVar[] extractStarts(List<? extends Slice> slices) {
