...
/**
 * A mock object to get various duration. Each duration is a constant given
...
public class MockDurationEvaluator implements DurationEvaluator {
	...
	private static final int IDX_FORGE = 8;
	 ...
	 *            the cost of a run
	 * @param lres
	 *            the cost of a local resume
	 * @param rres
	 *            the cost of a remote resume
	 * @param su
	 *            the cost of a suspend
	 * @param start
	 *            the cost of a startup
	 * @param shut
	 *            the cost of a shutdown
	 */
	public MockDurationEvaluator(int f, int m, int st, int r, int lres,
			int rres, int su, int start, int shut) {
		this();
		costs[IDX_FORGE] = f;
		costs[IDX_MIGRATE] = m;
		costs[IDX_STOP] = st;
