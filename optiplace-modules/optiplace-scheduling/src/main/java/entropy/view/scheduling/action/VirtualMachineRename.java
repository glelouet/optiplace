...
/**
 * An action to rename a virtual machine. The virtual machine must be known and
 * the new name must not be already used by another virtual machine
 * 
...
public class VirtualMachineRename extends VirtualMachineAction {
	 ...
	 * 
	 * @param vm
	 *            the virtual machine to rename
	 * @param n
	 *            the current hosting node. If it is {@code null}, the VM is
	 *            supposed to be waiting
	 * @param newName
	 *            the new name of the virtual machine. Must not be already used
	 ...
	 */
	public VirtualMachineRename(VirtualMachine vm, Node n, String newName,
