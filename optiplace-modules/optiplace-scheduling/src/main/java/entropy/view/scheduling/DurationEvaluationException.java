...
public class DurationEvaluationException extends Exception {
	 ...
	 * 
	 * @param expr
	 *            the expression where evaluation fail
	 * @param t
	 *            the original stack trace
	 * @param opts
	 *            the parameters used to evaluate the expression
	 */
	public DurationEvaluationException(String expr, Throwable t, Object... opts) {
		super("Unable to evaluation the expression '" + expr
				+ "' with parameters: " + Arrays.toString(opts), t);
	}
