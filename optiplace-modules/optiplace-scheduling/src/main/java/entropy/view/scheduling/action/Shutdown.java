...
public class Shutdown extends NodeAction {
	 ...
	 * @return true if o is an instance of Shutdown and if both actions act on
	 *         the same node
	 */
	@Override
	 ...
	 * @param c
	 *            the configuration
	 * @return {@code true} if the node was online and is set offline.
	 ...
	 * configuration. The node must be online in the source configuration and
	 * offline is the destination configuration.
	 * 
	 * @param src
