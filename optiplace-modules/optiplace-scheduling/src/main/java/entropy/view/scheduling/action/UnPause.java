...
public class UnPause extends VirtualMachineAction {
	 ...
	 * @param f
	 *            the finish moment of the action
	 */
	 ...
	 * @return true if ref is an instanceof UnPause and if both instance involve
	...
	/**
	 * Check the compatibility of the action with a source configuration. Not
	 * implemented
	 * 
	 * @param src
	 ...
	 * 
	 * @param graph
	 *            the graph to insert the action into
	...
	public String toString() {
		return new StringBuilder("unpause(")
				.append(getVirtualMachine().getName()).append(")").toString();
	}
