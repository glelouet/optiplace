...
/**
 * Abstract definition of an action that reconfigure a architecture. An action
 * manipulate either virtual machines or nodes. Regarding to the duration of its
 * execution, the action can be unbounded or bounded.
 * 
...
public abstract class Action {
	 ...
	 *            The moment the execution starts.
	 * @param f
	 *            the moment the execution stops.
	 */
	 ...
	 * 
	 * @param s
	 *            the moment the execution start.
	 */
	 ...
	 * 
	 * @param graph
	 *            the graph to insert the component into
	 * @return {@code true} if the component was inserted. False otherwise
	 */
	public abstract boolean insertIntoGraph(TimedExecutionGraph graph);
	 ...
	 * @throws IOException
	 *             if an error occurred while serializing the action.
	 */
	public abstract void serialize(TimedReconfigurationPlanSerializer s)
			throws IOException;
}
