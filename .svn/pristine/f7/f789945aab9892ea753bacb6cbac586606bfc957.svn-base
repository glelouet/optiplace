...
public class VirtualMachineTemplateFactoryBuilderFromProperties implements
    VirtualMachineTemplateFactoryBuilder {
  ...
  @Override
  public VirtualMachineTemplateFactory build()
      throws VirtualMachineTemplateFactoryBuilderException {
    ...
    try {
      ...
      if (props.isDefined(TO_LOAD_PROPERTY)) {
        try {
          ...
          throw new VirtualMachineTemplateFactoryBuilderException(
              "Unable to build the template factory: " + e.getMessage(), e);
        }
