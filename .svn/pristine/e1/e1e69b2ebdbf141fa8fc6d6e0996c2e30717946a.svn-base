...
public interface ConfigurationAdapterBuilder {
   ...
   * @throws MonitorFactoryException if an error occurred while creating the
   * adapter. */
  ConfigurationAdapter build(String configurationFile)
      throws MonitorFactoryException;

  /** Get the name of the configuration file in the distribution. File must be
