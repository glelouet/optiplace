...
public class GraphPartitioner implements PlanPartitioner {
  ...
  public GraphPartitioner(Configuration cfg) {
    ...
    // ie all the bitset between 0 and idxVMs - 1 have their bit from idxVMs
    // to the end, set
  ...
  public void part(Spread s) throws PartitioningException {
    ...
    ManagedElementSet<VirtualMachine> vs = s.getAllVirtualMachines();
  ...
  @Override
  public void part(Among s) throws PartitioningException {
