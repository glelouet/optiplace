...
public class SimpleNode implements Node, Cloneable {
	...
	boolean liveMigrating = true;

	@Override
	public boolean isLiveMigrating() {
		return liveMigrating;
	}

	@Override
	public void setLiveMigrating(boolean liveMigrating) {
		this.liveMigrating = liveMigrating;
	}
}
