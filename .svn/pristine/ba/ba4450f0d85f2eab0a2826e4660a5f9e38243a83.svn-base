...
/** A driver to perform a run action with an shell command executed on the
 ...
 * machine, the name of the source node and the name of the destination node</td>
 * <td>-</td>
 * </tr>
 * </table>
...
public class SSHRun extends SSHDriver {
   ...
   * @throws PropertiesHelperException if an error occurred while configuring
   * the driver */
