...
/** Exception throws when a virtual machine is not assignable to any node of a
 * configuration.
...
public class AssignmentException extends Exception {
  ...
  public String getMessage() {
    if (vm != null) {
      return "Unable to assign the virtual machine " + vm
          + "to a node of the configuration:\n" + c;
    } else if (c != null) {
