...
public class MockConfigurationAdapterBuilder implements
    ConfigurationAdapterBuilder {
  @Override
  public ConfigurationAdapter build(String file) throws MonitorFactoryException {
    return new MockConfigurationAdapter();
  }
