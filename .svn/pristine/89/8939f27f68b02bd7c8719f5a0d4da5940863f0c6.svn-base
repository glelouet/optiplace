...
public class TestExplodedSet {
  ...
  public void testEmpty() {
    VJobSet<SimpleNode> ns = new ExplodedSet<SimpleNode>();
  ...
  public void testLabel() {
    VJobSet<SimpleNode> ns = new ExplodedSet<SimpleNode>("$T1");
  ...
  public void testNonEmpty() {
    ExplodedSet<SimpleNode> ns = new ExplodedSet<SimpleNode>("$T1");
    ns.add(new SimpleNode("N1", 1, 1, 1));
    ns.add(new SimpleNode("N2", 1, 1, 1));
    Assert.assertEquals(ns.pretty(), "$T1");
