...
/** A Default template that is customized at instantiation. The identifier of the
 * builded virtual machine will be a class 4 UUID.
...
public class StubVirtualMachineTemplate implements VirtualMachineTemplate {
  ...
  public StubVirtualMachineTemplate(String id, int nbCPU, int cpu, int mem,
      THashSet<String> options) {
    this.id = id;
    nbCPUs = nbCPU;
    this.cpu = cpu;
    this.mem = mem;
  ...
  @Override
  public VirtualMachine build(String name, Map<String, String> options)
  ...
  public boolean equals(Object o) {
    ...
    return cpu == that.cpu && mem == that.mem && nbCPUs == that.nbCPUs
        && id.equals(that.id) && options.equals(that.options);
  }
