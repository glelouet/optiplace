...
public final class PropertiesHelper {
   ...
   * @throws MissingRequiredPropertyException if the property is unknown. */
   ...
   * @throws MissingRequiredPropertyException if the property is unknown.
   * @throws WrongPropertyTypeException if its value can not be parsed as an
   * Integer */
  public int getRequiredPropertyAsInt(String key)
      throws MissingRequiredPropertyException, WrongPropertyTypeException {
    int v;
    String value = null;
    try {
      value = getRequiredProperty(key);
   ...
   * @throws WrongPropertyTypeException if its value can not be parsed as an
   * Integer */
  public boolean getRequiredPropertyAsBoolean(String key)
      throws MissingRequiredPropertyException, WrongPropertyTypeException {
    String value = null;
    boolean b;
    try {
   ...
   * @throws WrongPropertyTypeException if its value can not be parsed as an
   * Integer */
  public int getOptionalProperty(String key, int defaultValue)
      throws WrongPropertyTypeException {
    String rep = props.getProperty(key);
    if (rep != null) {
      try {
   ...
   * @throws WrongPropertyTypeException if its value can not be parsed as an
   * Integer */
  public boolean getOptionalProperty(String key, boolean defaultValue)
      throws WrongPropertyTypeException {
    String rep = props.getProperty(key);
    if (rep != null) {
      try {
