...
public class SolutionStatistics /* extends SolvingStatistics */{
	...
	/**
	 * Indicates whether the solution denotes a solution of an optimization
	 * problem or not.
	 */
	 ...
	 * 
	 * @param nbNodes
	 *            the number of opened node to get the solution
	 * @param nbBacktracks
	 *            the number of backtracks to get the solution
	 * @param timeCount
	 *            the duration of the solving process to get the solution in ms
	 * @param objective
	 ...
	 * 
	 * @return {@code true} is the solution denotes a solution for an
	 *         optimization problem
	 */
	public boolean isOptimizationProblem() {
		return isOptimizationProblem;
	}
	...
	public String toRawData() {
		return new StringBuilder()
				.append(isOptimizationProblem ? objective : '-').append(' ')
				.append(nbNodes).append(' ').append(nbBacktracks).append(' ')
				.append(timeCount).toString();
	}
	...
	public SolutionStatistics clone() {
		SolutionStatistics c = new SolutionStatistics(nbNodes, nbBacktracks,
				timeCount);
