...
public class TestPBNodeSerializer {
  ...
  public void testRead() {
    ...
    pb.setName("pl1");
    PBNode.Node.Platform.Option.Builder ob = PBNode.Node.Platform.Option
        .newBuilder();
    ob.setKey("o1");
    ob.setValue("v1");
    ...
    Assert.assertTrue(n.getAvailablePlatforms().size() == 1
        && n.getCurrentPlatform().equals("pl1"));
  ...
  public void testRoundTripConversion() {
    ...
    Assert.assertTrue(n.getAvailablePlatforms().size() == 2
        && n.getAvailablePlatforms().contains("any")
        && n.getAvailablePlatforms().contains("bar"));
    Assert.assertEquals(n.getPlatformOptions("any"),
        n2.getPlatformOptions("any"));
    Assert.assertEquals(n.getPlatformOptions("bar"),
        n2.getPlatformOptions("bar"));
  }
}
