...
/** Prepare the unit tests and provides some tools to read resources for tests
 * purpose.
...
public class TestHelper {
  ...
  public static final String DISTRIBUTION_PROPERTIES = "config/entropy.properties";
  ...
  /** Read the properties provided in the distribution. The test fails in an
   * error occurred.
   * @return the properties */
