...
public class TestXenVirtualMachineBuilder {
  ...
  public void testInstantiation() throws Exception {
    ...
    Assert.assertEquals(b.getConfigDir(),
        "src/test/resources/entropy/template/xen/xenCfgs");
  }
   ...
   * @throws entropy.vjob.builder.VJobBuilderException the exception we expect */
