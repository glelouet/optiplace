...
/** Utility class to serialize and un-serialize a VirtualMachine to/from its
 * protobuf version.
...
public final class PBVirtualMachineSerializer {
  ...
  public static PBVirtualMachine.VirtualMachine write(VirtualMachine vm) {
    PBVirtualMachine.VirtualMachine.Builder b2 = PBVirtualMachine.VirtualMachine
        .newBuilder();
    ...
    PBVirtualMachine.VirtualMachine.Option.Builder b = PBVirtualMachine.VirtualMachine.Option
        .newBuilder();
