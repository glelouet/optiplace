...
public class TestGangliaAdapterBuilder {
  ...
  public void testBuild() {
    try {
      ...
      GangliaConfigurationAdapter g = b
          .build("src/test/resources/entropy/monitoring/ganglia/TestGangliaAdapterBuilder.props.txt");
  ...
  public void testDistributionBuild() {
    try {
      GangliaAdapterBuilder b = new GangliaAdapterBuilder();
      GangliaConfigurationAdapter g = b.build("config/ganglia.properties");
      Assert.assertEquals(g.getHostname(), "localhost");
