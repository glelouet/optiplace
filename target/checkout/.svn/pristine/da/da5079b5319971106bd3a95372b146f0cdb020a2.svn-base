...
/** Unit tests for {@code SetsUnion}.
 * @author Fabien Hermenier */
@Test(groups = { "unit" })
public class TestSetsUnion {
  ...
  public void testExpand() {
    ...
    VJobSet u = new SetsUnion<SimpleNode>(new ExplodedSet<SimpleNode>(ns1),
        new ExplodedSet<SimpleNode>(ns2));
    Assert.assertEquals(u.flatten(), res);
  }
