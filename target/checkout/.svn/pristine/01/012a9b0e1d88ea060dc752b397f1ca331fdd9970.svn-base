    ...
    if (props.isDefined(CATALOG_CONTENTS_PROPERTIES)) {
      try {
        ...
        for (String constraint : constraints) {
          ...
          // c.add((PlacementConstraintBuilder)
          // cl.getConstructor(VJobBuilder.class,
          // String.class).newInstance(new Object[]{vJobBuilder,
          // constraint}));
          c.add((PlacementConstraintBuilder) cl.newInstance());
        }
        PlasmaVJob.logger.debug("Available constraints for plasma vjobs: "
