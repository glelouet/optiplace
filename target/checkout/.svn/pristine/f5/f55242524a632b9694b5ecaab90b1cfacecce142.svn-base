...
public abstract class CustomizablePlannerModule implements Planner {
  ...
  /** The time that was necessary to generate the problem. */
  ...
  /** Compute a new Defaultentropy.plan.ReconfigurationResult that satisfy all the
   ...
   * @throws PlanException if an error occurred while planing the action to
   * reach the state of the nodes and the virtual machines */
  @Override
  public abstract entropy.plan.ReconfigurationResult compute(Configuration src,
  ...
  /** Get statistics about the computed solutions. Solutions are sorted in an
   * ascending duration.
