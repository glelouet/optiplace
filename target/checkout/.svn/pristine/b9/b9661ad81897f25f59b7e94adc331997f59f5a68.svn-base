...
public interface PlatformFactory {
  ...
  /** Get an hosting platform associated with the identifier. The platform is
   * cloned and options can be added without side effects
   * @param k the identifier of the platform
   * @return a platform if the given identifier match an available platform or
   * {@code null} */
