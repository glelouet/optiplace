...
/** A catalog contains several constraints available to restrict the placement of
 * virtual machines.
...
public interface ConstraintsCatalog {
   ...
   * @return a placement constraint or {@code null} if no constraint is
   * associated to the given identifier
   * @throws ConstraintBuilderException if an error occurred while building the
   * constraint */
  PlacementConstraint buildConstraint(String id, List<VJobElement> params)
