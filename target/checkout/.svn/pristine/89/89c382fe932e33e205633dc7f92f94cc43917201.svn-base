...
public class TestFirstFitVJobScheduler {
  ...
  public void testValidAppend1() {
    ...
    Configuration c = TestHelper.readConfiguration(RESOURCES_DIR
        + "confValidAppend1.txt");

    try {
      VirtualMachineTemplateFactory f = new MockVirtualMachineTemplateFactory();
      PlasmaVJobBuilder b = new PlasmaVJobBuilder(
          new DefaultVJobElementBuilder(f), null);
      b.getElementBuilder().useConfiguration(c);
      PlasmaVJob l = b.build("lease1", new File(RESOURCES_DIR + "lease1.txt"));
      q.add(l);
      ...
      Assert.assertEquals(res.getRunnings().size(), l.getVirtualMachines()
          .size());
  ...
  public void testValidAppend2() {
    ...
    try {
      ...
      PlasmaVJobBuilder b = new PlasmaVJobBuilder(
          new DefaultVJobElementBuilder(f), null);
      b.getElementBuilder().useConfiguration(c);
      PlasmaVJob l = b.build("lease2", new File(RESOURCES_DIR + "lease2.txt"));
      q.add(l);
      FirstFitVJobScheduler ff = new FirstFitVJobScheduler(q);
      Configuration res = ff.compute(c);
  ...
  public void testValidAppend3() {
    ...
    try {
      Configuration c = TestHelper.readConfiguration(RESOURCES_DIR
          + "testValidAppend3_src.txt");
      VirtualMachineTemplateFactory f = new MockVirtualMachineTemplateFactory();
      PlasmaVJobBuilder b = new PlasmaVJobBuilder(
          new DefaultVJobElementBuilder(f), null);
      b.getElementBuilder().useConfiguration(c);
      PlasmaVJob v = b.build("lease3", new File(RESOURCES_DIR + "lease3.txt"));
      q.add(v);
      FirstFitVJobScheduler ff = new FirstFitVJobScheduler(q);
      Configuration res = ff.compute(c);
      Assert.assertEquals(res.getRunnings().size(), v.getVirtualMachines()
          .size());
      Assert.assertEquals(res.getOnlines(), c.getOnlines());
    }
    catch (Exception e) {
  ...
  public void testCompute1() {
    ...
    try {
      ...
      PlasmaVJobBuilder b = new PlasmaVJobBuilder(
          new DefaultVJobElementBuilder(f), null);
      b.getElementBuilder().useConfiguration(c);
      PlasmaVJob l1 = b.build("lease1", new File(RESOURCES_DIR + "lease1.txt"));
      PlasmaVJob l2 = b.build("lease2", new File(RESOURCES_DIR + "lease2.txt"));
      PlasmaVJob l3 = b.build("lease3", new File(RESOURCES_DIR + "lease3.txt"));
      q.add(l1);
      q.add(l2);
      q.add(l3);
      ...
      FirstFitVJobScheduler ff = new FirstFitVJobScheduler(q);
      Configuration res = ff.compute(c);
      Assert.assertEquals(res.getRunnings().size(), l1.getVirtualMachines()
          .size()
          + l2.getVirtualMachines().size()
          + l3.getVirtualMachines().size());
    }
    catch (Exception e) {
      Assert.fail(e.getMessage(), e);
    }
  ...
  public void testCompute2() {
    ...
    try {
      ...
      b.getElementBuilder().useConfiguration(c);
      PlasmaVJob l1 = b
          .build("leasee1", new File(RESOURCES_DIR + "lease1.txt"));
      PlasmaVJob l2 = b
          .build("leasee2", new File(RESOURCES_DIR + "lease2.txt"));
      PlasmaVJob l3 = b
          .build("leasee3", new File(RESOURCES_DIR + "lease3.txt"));
      q.add(l1);
      q.add(l2);
      q.add(l3);
      FirstFitVJobScheduler ff = new FirstFitVJobScheduler(q);
      Configuration res = ff.compute(c);
      Assert.assertEquals(res.getRunnings().size(), l1.getVirtualMachines()
          .size() + l3.getVirtualMachines().size());
      for (VirtualMachine vm : l2.getVirtualMachines()) {
        Assert.assertTrue(res.getWaitings().contains(vm));
      }
      Assert.assertEquals(res.getWaitings().size(), l2.getVirtualMachines()
          .size());
