...
public class XMLVJobBuilderBuilder implements VJobBuilderBuilder {
  ...
  @Override
  public XMLVJobBuilder build(VJobElementBuilder eb)
      throws VJobBuilderBuilderException {
    try {
      propHelper = new PropertiesHelper(file);
      XMLConstraintsCatalog c = new ConstraintsCatalogBuilderFromProperties(
          propHelper).build();
