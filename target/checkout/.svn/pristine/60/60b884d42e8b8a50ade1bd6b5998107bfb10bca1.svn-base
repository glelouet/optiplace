...
public final class XMLPlacementConstraintBuilders {
   ...
   * {@code x} */
  public static void ensureArity(XMLPlacementConstraintBuilder b,
      List<Param> elems, int x) throws ConstraintBuilderException {
    int s = elems.size();
    if (s != x) {
      throw new ConstraintBuilderException(new StringBuilder(b.getSignature())
          .append(" expects 2 arguments. ").append(s).append(" given.")
          .toString());
    }
  }
  ...
  public static void noEmptySets(Object buf, Collection<?> s)
  ...
  public static List<ManagedElementSet<VirtualMachine>> makeVirtualMachinesSet(
      VJobElementBuilder eBuilder, Param p) throws ConstraintBuilderException {
  ...
  public static Set<ManagedElementSet<Node>> makeNodesSet(
      VJobElementBuilder elementBuilder, Param elems)
      throws ConstraintBuilderException {
  ...
  public static ManagedElementSet<Node> makeNodes(VJobElementBuilder eBuilder,
      Param p) throws ConstraintBuilderException {
    if (p.type != Param.Type.set) {
      throw new ConstraintBuilderException(p + " must be a set");
    }
    List<Param> ps = (List<Param>) p.value;
  ...
  public static Node matchNode(VJobElementBuilder eBuilder, Param p)
      throws ConstraintBuilderException {
    if (p.type != Param.Type.node) {
      throw new ConstraintBuilderException(p + " must be a node. Given is '"
          + p.type + "'");
    }
  ...
  public static VirtualMachine matchExistingVirtualMachine(
      VJobElementBuilder eBuilder, Param p) throws ConstraintBuilderException {
  ...
  public static int makeInt(Param p) throws ConstraintBuilderException {
    if (p.type != Param.Type.nb) {
      throw new ConstraintBuilderException(p + " must be a number");
    }
