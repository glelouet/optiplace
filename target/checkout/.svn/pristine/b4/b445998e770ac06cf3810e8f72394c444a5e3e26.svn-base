...
public class TestControlLoopFactory {
  ...
  // test fails : entropy.MissingRequiredPropertyException: Missing required
  // property 'controlLoop.custom.prediction.step'
  ...
  //
  // ControlLoop l = f.makeControlLoop(m, vjobF);
  ...
  // TestHelper.DISTRIBUTION_PROPERTIES);
  // ControlLoopFactory f = new ControlLoopFactory(props);
  // f.makeControlLoop(null, null);
  // } catch (Exception e) {
  // Assert.fail(e.getMessage(), e);
