...
public class LazySplitBuilder implements XMLPlacementConstraintBuilder {
   ...
   * constraint */
  @Override
  public LazySplit buildConstraint(VJobElementBuilder eBuilder, List<Param> args)
      throws ConstraintBuilderException {
    XMLPlacementConstraintBuilders.ensureArity(this, args, 2);
    ManagedElementSet<VirtualMachine> vms1 = XMLPlacementConstraintBuilders
        .makeVMs(eBuilder, args.get(0));
    XMLPlacementConstraintBuilders.noEmptySets(args.get(0), vms1);
    ManagedElementSet<VirtualMachine> vms2 = XMLPlacementConstraintBuilders
