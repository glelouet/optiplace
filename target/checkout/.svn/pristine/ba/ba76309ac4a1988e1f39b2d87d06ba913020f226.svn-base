...
public final class FastDurationEvaluatorFactory {
  ...
  public static final String MIGRATION_DURATION_PROPERTY = BASE_PROPERTY
      + "migrate";
  ...
  public static final String LOCAL_SUSPEND_DURATION_PROPERTY = BASE_PROPERTY
      + "suspend@local";

  /** Identifier of the duration of a local resume. */
  public static final String LOCAL_RESUME_DURATION_PROPERTY = BASE_PROPERTY
      + "resume@local";

  /** Identifier of the duration of a remote resume. */
  public static final String REMOTE_RESUME_DURATION_PROPERTY = BASE_PROPERTY
      + "resume@remote";

  /** Identifier of the duration of a startup. */
  public static final String STARTUP_DURATION_PROPERTY = BASE_PROPERTY
      + "startup";

  /** Identifier of the duration of a shutdown. */
  public static final String SHUTDOWN_DURATION_PROPERTY = BASE_PROPERTY
      + "shutdown";

  /** Identifier of the duration of a VM forge. */
  public static final String FORGE_DURATION_PROPERTY = BASE_PROPERTY + "forge";

  /** No instantiation please. */
  private FastDurationEvaluatorFactory() {
   ...
   * @throws entropy.PropertiesHelperException if the property file does not
   * contains all the required properties */
  public static DurationEvaluator readFromProperties(PropertiesHelper props)
    ...
    String localResume = props
        .getRequiredProperty(LOCAL_RESUME_DURATION_PROPERTY);
    String remoteResume = props
        .getRequiredProperty(REMOTE_RESUME_DURATION_PROPERTY);
    ...
    String forge = props.getRequiredProperty(FORGE_DURATION_PROPERTY);
    try {
      return new FastANTLRDurationEvaluator(mig, stop, run, suspend,
          localResume, remoteResume, startup, shutdown, forge);
    }
    catch (DurationEvaluationException e) {
      throw new MissingRequiredPropertyException(e.getMessage());
    }
  }
}
