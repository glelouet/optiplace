...
public class TestPBVirtualMachineSerializer {
  ...
  public void testRead() {
    PBVirtualMachine.VirtualMachine.Builder b = PBVirtualMachine.VirtualMachine
        .newBuilder();
    b.setName("foo");
    ...
    PBVirtualMachine.VirtualMachine.Option.Builder ob = PBVirtualMachine.VirtualMachine.Option
        .newBuilder();
    ob.setKey("o1");
  ...
  public void testRoundTripConversion() {
    ...
    vm.addOption("o1");
    vm.addOption("o2", "v2");
    VirtualMachine vm2 = PBVirtualMachineSerializer
        .read(PBVirtualMachineSerializer.write(vm));
