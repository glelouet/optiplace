...
public interface ReconfigurationProblem extends Solver, CoreView {
	...
	/**
	 * Get the virtual machines that will be in the running state at the end of
	...
	/**
	 * Get the virtual machines that will be in the waiting state at the end of
	 * the reconfiguration process.
	 * 
	 * @return a set, may be empty
	 */
	...
	/**
	 * Get the virtual machines that will be in the sleeping state at the end of
	 * the reconfiguration process.
	 * 
	 * @return a set, may be empty
	 */
	...
	/**
	 * Get the virtual machines that will be in the terminated state at the end
	...
	/**
	 * get the virtual machines that can be migrated.
	 * 
	 * @return a set, should not be modified.
	 */
	ManagedElementSet<VirtualMachine> getManageable();

	/**
	 * Get the nodes that will be in the online state at the end of the
	 * reconfiguration process.
	 * 
	 * @return a set, may be empty
	 * @deprecated this has no meaning when the nodes states are not decided.
	 *             This should return {@link #getSourceConfiguration()} .
	 *             {@link Configuration.#getAllNodes()}
	 */
	@Deprecated
	ManagedElementSet<Node> getFutureOnlines();

	/**
	 * Get the nodes that will be in the offline state at the end of the
	 * reconfiguration process.
	 * 
	 * @return a set, may be empty
	 * @deprecated this has no meaning when the nodes states are not decided.
	 ...
	 *         group of nodes
	 */
	IntDomainVar makeGroup(ManagedElementSet<VirtualMachine> vms,
	 ...
	 */
	@Override
	HashMap<String, ResourceHandler> getHandlers();
