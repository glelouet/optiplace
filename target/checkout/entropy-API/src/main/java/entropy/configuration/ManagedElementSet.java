...
/**
 * Specify a list of managed elements without duplicated elements. The position
 * of the element has to be maintained.
 * 
 * @author Fabien Hermenier
 */
public interface ManagedElementSet<E extends ManagedElement> extends List<E> {
	 ...
	 * @param elems
	 *            the elements
	 * @return {@code true} if all the elements are in the set. {@code false}
	 *         otherwise
	 */

	boolean containsAll(ManagedElementSet<E> elems);
	 ...
	 * @param e
	 *            the element to add
	 * @return {@code true} if the element is now in the set. {@code false}
	 *         otherwise
	 */
	boolean add(E e);
	 ...
	 * @return the removed element. {@code null} if the element was not in the
	 *         set
	 */
	E remove(int i);
	 ...
	 */
	boolean addAll(ManagedElementSet<E> elems);
	 ...
	 */
	boolean removeAll(ManagedElementSet<E> elems);
	 ...
	 */
	boolean retainAll(ManagedElementSet<E> elems);

	/**
	 * Create a new set that is the substraction between this and the given set.
	 * 
	 * @param elems
	 *            the elements to substract
	 * @return a set that may be empty
	 */
	ManagedElementSet<E> minus(ManagedElementSet<E> elems);
