...
/** A stub builder. if a node or a VM is asked, it is created with all of the
 * resource capacities/usage equals to 1.
...
public class StubVJobElementBuilder implements VJobElementBuilder {
  ...
  @Override
  public VirtualMachine matchVirtualMachine(String id, String tpl,
