...
public class XMLVJobHandler extends DefaultHandler {
  ...
  public void startDocument() throws SAXException {
    options = new THashMap<String, String>();
    params = new ArrayList<Param>();
    setsStack = new Stack<Param>();
  }
  ...
  public void endElement(String s, String s1, String s2) throws SAXException {
    if (s2.equals("option")) {
      ...
      VirtualMachine vm = eBuilder.matchVirtualMachine(currentVMDeclID,
          currentVMDeclTpl, options);
      if (vm == null) {
        throw new SAXException("Unable to declare virtual machine '"
            + currentVMDeclID + "'");
      }
      ...
      XMLPlacementConstraintBuilder cb = catalog
          .getConstraint(currentConstraintId);
      if (cb == null) {
        throw new SAXException("Constraint '" + currentConstraintId
            + "' unknown");
      }
      try {
  ...
  public void startElement(String s, String s1, String s2, Attributes attributes)
    ...
    if (s2.equals("vjob")) {
      ...
      currentConstraintId = attributes.getValue("id");
      params.clear();
      ...
      if (id != null) {
        ...
        if (currentParam == null) {
          ...
          ((List<Object>) setsStack.peek().value).add(p);
        }
      }
