...
public class ProtobufVJobSerializer extends VJobFileSerializer implements
    VJobSerializer {
  ...
  public static PBVJob.vjob.Set getNodeBigSet(
      Set<ManagedElementSet<Node>> snodes) {
    PBVJob.vjob.Set.Builder b = PBVJob.vjob.Set.newBuilder();
  ...
  public static PBVJob.vjob.Set getVMBigSet(
      List<ManagedElementSet<VirtualMachine>> svms) {
    PBVJob.vjob.Set.Builder b = PBVJob.vjob.Set.newBuilder();
    b.setType(PBVJob.vjob.Set.Type.SET);
