...
/** An executor that execute an action in parallel. Once the execution is
 * terminated, it is signaled to the reconfiguration executer using the method
 * commit.
...
public class Executor extends Thread {
  ...
  /** Start to execute the action in another thread. When the action is
   * terminated, it is signaled to the TimedReconfigurationExector even if an
   * error occurred */
  @Override
  public void run() {
    try {
