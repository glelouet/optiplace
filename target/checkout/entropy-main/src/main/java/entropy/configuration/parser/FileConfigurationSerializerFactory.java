 ...
 * <ul>
 * <li>{@link PlainTextConfigurationSerializer}: File extension must be
 * {@value #PLAIN_TEXT_EXTENSION}.</li>
 * <li>{@link ProtobufConfigurationSerializer}: File extension must be
 * {@value #PROTOBUF_EXTENSION}.</li>
 * </ul>
...
public final class FileConfigurationSerializerFactory {
  ...
  /** Read a configuration from a file. The serializer to use is inferred using
   * the file extension.
   * @param path the path to the file.
   * @return the parsed configuration or {@code null} if no serializer is
   * associated to the file extension
   * @throws IOException if an error occurred while reading the file
   * @throws ConfigurationSerializerException if an error occurred while parsing
   * the file */
  ...
  /** Write a configuration to a file. The serializer to use is inferred from the
   * file extension.
