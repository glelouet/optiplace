  ...
  public static void main(String[] args) {
    ...
    for (File f : root.listFiles()) {
      ...
      if (date.endsWith("-source.txt")) {
        try {
          Configuration c = PlainTextConfigurationSerializer.getInstance()
          ...
          System.out.println(d.getTime() / 1000 + " " + cpuCapa + " "
              + cpuConso + " " + memCapa + " " + memConso);
        }
        catch (Exception e) {
    ...
    System.err.println(100.0 * totalcpuConso / totalcpuCapa + "% CPU\t" + 100.0
        * totalMemConso / totalMemCapa + "%Mem");
  }
}
