...
public class TestDriverFactory {
  ...
  public static Object[][] getBadActions() {
    ...
    return new Object[][] { { new Migration(vm1, n3, n2) }, // No migration
        // driver
  ...
  public void testBadActions(Action a) throws DriverInstantiationException {
    PropertiesHelper props = TestHelper
        .readEntropyProperties("src/test/resources/entropy/execution/driver/TestDriverFactory.defaultProperties.txt");
