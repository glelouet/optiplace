...
public class TestSSHStop {
  ...
  public void testGetCommandToExecute() {
    Stop r = new Stop(new SimpleVirtualMachine("myVirtualMachine", 1, 2, 3),
    ...
    try {
      ...
      Assert.assertEquals(s.getCommandToExecute(),
          "plz stop myVirtualMachine. Its on fire on theSource");
    }
    catch (Exception e) {
  ...
  public void testDefaultProperties() {
    Stop r = new Stop(new SimpleVirtualMachine("vm1", 1, 2, 3), new SimpleNode(
        "n1", 1, 2, 3));
    try {
