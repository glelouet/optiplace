...
/**
 * An exception that define an incoherent resulting state for a virtual machine
 * or a node.
 * 
...
public class UnknownResultingStateException extends PlanException {
   ...
   */
	...
	/**
	 * An exception to show a virtual machine does not belong to any possible
	 * resulting state.
	 * 
	 * @param vm
	 *            the virtual machine
	...
	/**
	 * An exception to show a node does not belong to any possible resulting
	 * state.
	 * 
	 * @param n
	 *            the node
