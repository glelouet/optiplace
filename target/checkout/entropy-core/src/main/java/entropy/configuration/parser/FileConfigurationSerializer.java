 ...
 */
public abstract class FileConfigurationSerializer
		implements
	 ...
	 */
	public final Configuration read(String path) throws IOException,
	 ...
	 */
	public final void write(Configuration cfg, String path) throws IOException {
