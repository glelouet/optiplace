...
public class TestSimpleNode {
	...
	public void testLazyConstructor() {
		...
		n = new SimpleNode("N1", 1, 100, 1024, "192.168.0.1",
				"FF:FF:FF:FF:FF:FF");
	...
	/** Tests related to MEMORY_TOTAL. Tests on getter and setter */
	...
	/** Tests related to NbOfCPUs. Tests on getter and setter */
	public void testNbOfCPUs() {
		Node n = new SimpleNode("N1", 1, 100, 1024);
		// Test default value
		Assert.assertEquals(n.getNbOfCores(), 1);

		// Test the binding
		n.setNbOfCores(2);
		Assert.assertEquals(n.getNbOfCores(), 2);
	}

	/** Tests related to CPU_CAPACITY. Tests on getter and setter */
	public void testCPUCapacity() {
		Node n = new SimpleNode("N1", 1, 100, 1024);
		// Test default value
		Assert.assertEquals(n.getCoreCapacity(), 100);

		// Test the binding
		n.setCoreCapacity(200);
		Assert.assertEquals(n.getCoreCapacity(), 200);
	}
	...
	public void testCopyConstructor() {
		...
		Assert.assertEquals(n2.getNbOfCores(), 1);
	...
	public void testPlatform() {
		...
		Assert.assertEquals(n2.getAvailablePlatforms(),
				n.getAvailablePlatforms());
	}
}
